...
BEGIN
    ...
    RAISE NOTICE 'Product_code: %',par_product_code;
...
--    END IF;
    ...
    var_return_row.error_message := 'Line assignment succesful!';
    RAISE NOTICE 'Line assignment succesful:  Line: %  IP: %.', var_line_id, var_static_ip;
    RETURN NEXT var_return_row;
    RETURN;
