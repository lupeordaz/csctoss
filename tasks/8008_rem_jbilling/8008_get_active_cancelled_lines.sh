...
PGPASSWORD=owner /usr/bin/psql -q \
                               -h denoss01.contournetworks.net \
                               -p 5450 \
                               -d csctoss \
                               -U csctoss_owner \
                               -f ../../opentaps/opentaps_transaction_scripts/get_active_lines_from_jbill_and_oss_for_opentaps.sql
PGPASSWORD=owner /usr/bin/psql -q \
                               -h denoss01.contournetworks.net \
                               -p 5450 \
                               -d csctoss \
                               -U csctoss_owner \
                               -f ../../opentaps/opentaps_transaction_scripts/get_cancelled_lines_from_jbill_and_oss_for_opentaps.sql
