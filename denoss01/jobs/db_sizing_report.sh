...
psql -U postgres -d $1 -c "SELECT * FROM ROUND(public.pg_database_size('$1')::numeric/1048576,2)" > ./db_sizing_report.txt
...
for NAME in {"aallard@contournetworks.com","dba@cctus.com"}; do
