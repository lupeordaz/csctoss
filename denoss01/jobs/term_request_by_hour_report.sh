...
#RECIP2="yshibuya@cctus.com"
#RECIP3="yshibuya@cctus.com"
#RECIP4="yshibuya@cctus.com"
#toMe="yshibuya@cctus.com"
...
echo "  CASE WHEN hour='Totals: ' " >> $SQL_FILE
echo '    THEN hour ELSE lpad(hour,2,0) ' >> $SQL_FILE
echo '  END AS "Hr", ' >> $SQL_FILE
echo '  ar_count_spr AS "Admin Reset", ' >> $SQL_FILE
echo '  ne_count_spr AS "NAS Error", ' >> $SQL_FILE
echo '  ss_count_spr AS "Short Session", ' >> $SQL_FILE
echo '  this_space AS "--", ' >> $SQL_FILE
echo '  ar_count_usc AS "Admin Reset", ' >> $SQL_FILE
echo '  ne_count_usc AS "NAS Error", ' >> $SQL_FILE
echo '  ss_count_usc AS "Short Session ", ' >> $SQL_FILE
echo '  this_space AS "--", ' >> $SQL_FILE
echo '  ar_count_vzw AS "Admin Reset", ' >> $SQL_FILE
echo '  ne_count_vzw AS "NAS Error", ' >> $SQL_FILE
echo '  ss_count_vzw AS "Short Session " ' >> $SQL_FILE
...
echo "&nbsp;  HR &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;SPRINT &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;  USCC  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;  VZW"  >> $LOGFILE_HDR
#echo " " > $testOutput
