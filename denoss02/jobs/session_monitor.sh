...
. $BASEDIR/jobs/timestamp_count_func.sh
...
if [ $DELAY -gt 600 ]; then
  ...
  echo "CSCTMON (`hostname`) AcctStartDelay is $DELAY seconds." | mail -s "CSCTMON (`hostname`) Delay Exceeds Threshold." btekeste@cctus.com
